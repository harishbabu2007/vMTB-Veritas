        ...
        <div className="bg-surface rounded-2xl shadow-sm p-8">
          ...
          <div className="text-center">
            ...
            <div className="inline-flex items-center justify-center bg-success-bg-strong rounded-full mb-6 w-16 h-16">
              <CheckCircle className="text-success w-8 h-8" strokeWidth={1.5} />
            </div>
            ...
            <div className="space-y-2 mb-8 text-left">
              <div className="flex items-start gap-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-success-bg-strong flex items-center justify-center mt-0.5">
            ...
            <div className="pt-6 border-t border-border">
              ...
              <button
                ...
                className="text-sm font-medium transition mb-4 text-link"
              >
