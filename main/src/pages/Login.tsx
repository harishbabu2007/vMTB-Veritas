      ...
      <div className="w-full max-w-md">
        <div className="bg-surface rounded-2xl shadow-sm p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-border rounded-lg font-medium text-text transition hover:bg-surface-hover disabled:opacity-50 disabled:cursor-not-allowed mb-6"
          >
            {googleLoading ? (
              <div
          ...
          {mode === 'password' && (
            <form onSubmit={handlePhonePasswordLogin} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-primary-solid hover:bg-primary-solid-hover text-on-solid py-2.5 rounded-lg font-medium transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="mt-7 text-center space-y-3">
            {mode === 'password' && (
              <button
                ...
                className="block w-full text-sm font-medium transition text-link"
              >
                Login using OTP
              </button>
            )}
            <Link
              to="/forgot-password"
              className="block text-sm font-medium transition text-link"
            >
            ...
            <div className="text-sm text-text-muted">
              ...
              <Link
                to="/signup"
                className="font-semibold transition text-link"
              >
                Sign Up
              </Link>
            </div>
