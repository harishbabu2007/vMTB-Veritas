  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-24 px-6 text-center" role="alert">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg border border-border text-text bg-surface hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
